...
import {Bell, Construction, Mail, MessageCircle} from "lucide-solid"
import {
  Card,
  CardContent,
  CardDescription,
...
import CreateEditAlertDialog, {
  type RuleSaveData
} from "@/components/notifications/create-edit-alert-dialog"
...
const alertTypeLabel = (t: AlertType) => {
  switch (t) {
    case "low_balance":
      return "Saldo Abaixo do Esperado"
    case "spending_limit":
